            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              {user ? (
                <div className="flex items-center gap-4">
                  ...
                  <Link
                    href="/messages"
                    className="relative text-slate-600 hover:text-primary-600 transition p-1"
            ...
            <div className="md:hidden py-4 border-t border-slate-100 space-y-1" role="menu">
              ...
              {!user && (
                <>
                  ...
                  <Link href="/sell" className="block py-2 px-3 text-slate-700 hover:bg-slate-50 rounded-lg font-medium" onClick={() => setMobileOpen(false)}>Sell Your Truck For Free!</Link>
                </>
              )}
              {user ? (
                <>
                  <Link
                    href="/messages"
                    className="flex items-center justify-between py-2 px-3 text-slate-700 hover:bg-slate-50 rounded-lg font-medium"
